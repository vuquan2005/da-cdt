...
package_name = 'robot0_controller'
...
setup(
    ...
    description='Kinematics and Base Controller package for Robot0 Mecanum mobile base',
    license='BSD-3-Clause',
    entry_points={
        'console_scripts': [
            'kinematics_node = robot0_controller.kinematics_node:main',
        ],
    },
)
